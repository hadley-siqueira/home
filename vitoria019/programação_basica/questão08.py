...
altura = int (input("informe o numero para altura do paralelepipedo "))
comprimento = int(input("informeo numero para o comprimento: ")) 
largura = int(input("informe o numero para a largura: "))
...
calc = alt + larg
print(' o valume de cubo eh ' + str(calc))
...
divi = esfera / raio
print('o raio da esfera eh ' + str(calc))
