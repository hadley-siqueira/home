...
vy = int(input("Digite a coordenada y do primeiro vertice do retandulo:"))
vx1 = int(input("Digite a coordenada x do segundp vertce do retangulo:"))
vx2 = int(input("Digite a coordenada y do segundo vertice do retangulo:"))
